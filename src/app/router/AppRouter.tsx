...
const HostPlayPage = lazy(() => import('../../features/host-control/pages/HostPlayPage').then(module => ({ default: module.HostPlayPage })))
    ...
    <BrowserRouter>
      <Suspense fallback={<LoadingView />}>
        <Routes>
          ...
          <Route path="/room/:code/host/play" element={<HostPlayPage />} />
