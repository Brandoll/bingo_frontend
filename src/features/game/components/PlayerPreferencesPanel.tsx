import { Accessibility, CircleDotDashed, Sparkles, Volume2 } from 'lucide-react'
import type { PlayerPreferences } from '../../../services/storage/playerPreferences'
import { prepareBingoCageSound } from '../../../services/audio/bingoCageSound'
  ...
  return (
    <details className="player-preferences">
      ...
      <div>
        ...
        <label><span><CircleDotDashed /> Sonido de bolillero<small>Reproduce el giro y choque de las bolas.</small></span><input type="checkbox" checked={preferences.cageSound} onChange={() => { if (!preferences.cageSound) void prepareBingoCageSound(); onChange({ cageSound: !preferences.cageSound }) }} /></label>
